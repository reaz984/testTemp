                        ...
                        if ($txt_qty != "") {
                            for ($i = 1; $i <= $txt_qty; $i++) {
                                ...
                                <tr id="assetSlNo_<?php echo $i; ?>">
                                    ...
                                    <? if( str_replace("'", "", $cbo_aseet_type) == 10){ ?>
                            ...
                            <td>
                                <input type="button" name="decrease_1" id="decrease_1" value="-" class="formbutton" onClick="fn_deleteRow1(<?php echo $i; ?>)" style="width:50px"/>
...
// Start : Update Here----------------------------------------------------------
    else if ($operation == 1)
	{
        ...
        for ($a = 0; $a < count($txt_set_qty_hidden_row); $a++)
		{
			...
			{
                if ($data_array_acquisition_set != "") $data_array_acquisition_set.=",";
        ...
        for ($e = 0; $e < count($txt_serial_no_hidden_row); $e++) 
		{
			...
			if ($db_type == 0) $warranty_date = change_date_format($update_warrantyDate, 'DD-MMM-YYYY');
			if ($db_type == 2) $warranty_date = change_date_format($update_warrantyDate, 'DD-MMM-YYYY', '-', 1);
...
if ($action == "populate_asset_details_form_data")
{
    ...
    foreach ($data_array as $row)
	{
        ...
        if ($row[csf("asset_uom")] == 58)
		{
			...
			{
                if ($set_break_down != "") $set_break_down.="*";
        ...
        if ($row[csf("qty")] != "")
		{
			...
			{
                if ($sl_break_down != "") $sl_break_down.="*";
